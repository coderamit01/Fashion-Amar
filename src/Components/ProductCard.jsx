...
const ProductCard = ({ product }) => {
  const { title, thumbnail, rating, category,price,discountPercentage } = product;
  const discountPrice = price - (price * discountPercentage) /100;
  return (
    <div className="transition border border-[#ececec] rounded hover:shadow-new hover:border-[#BCE3C9]">
